...
# model_file = os.path.join('../models/einet/demo_mnist_3/', "einet.mdl")
...
image = image_expectation(392)

exp_dir = '../expectation/demo_mnist_3/1/'
    
utils.mkdir_p(exp_dir)


utils.save_image_stack(torch.reshape(image,(1,28,28)), 1, 1, os.path.join(exp_dir, f'exp_image_1.png'), margin_gray_val=0.)